...
class GenerationShip:
    ...
    def generate_population(self):
        ...
        for n in range(self.N_pop):
            self.population.append(cir.Circus(self.circ_elements, self.gene_size))
    ...
    def eval_fitness_pop(self):
        ...
        for circ in self.population:
            ...
            self.fitness_pop.append(cir.eval_fitness(circ.circuit))
    ...
    def run_generations(self,generation_limit):
        ...
        for time in range(generation_limit):
            ...
            if min_fit<best_fit:
                ...
                print(best_circuit.gene,min_fit)
                #self.arq.write(",".join(best_circuit))
                #self.arq.write(" {}\n".format(min_fit))
        best_circuit.add_jumpers()
        best_circuit.draw_circuit()
        print(min_fit)
        # print(best_circuit.gene_jumper)
    ...
    def raise_generation(self):
        ...
        #     parent1,parent2=self.selection()
            ...
            child1,child2=cir.crossover(self.population[parent1],self.population[parent2],self.verbose)
...
def create_family(family_number=0,number_of_generations=10 ):
    elementos = cir.elements
    N_pop = 6
    gene_size = 6
    family=GenerationShip(family_number,elementos,gene_size,N_pop,False)
